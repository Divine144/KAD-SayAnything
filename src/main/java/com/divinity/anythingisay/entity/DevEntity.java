...
public class DevEntity extends PathfinderMob {

    public DevEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public DevEntity(Level pLevel) {
        super(EntityInit.DEV.get(), pLevel);
    }
